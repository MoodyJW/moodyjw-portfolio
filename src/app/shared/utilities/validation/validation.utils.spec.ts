...
describe('Validation Utils', () => {
  describe('isValidEmail', () => {
    ...
    it('should handle plus signs based on option', () => {
      ...
      expect(ValidationUtils.isValidEmail('user+tag@example.com', { allowPlus: false })).toBe(false);
    });
  ...
  describe('isValidUrl', () => {
    ...
    it('should validate allowed protocols', () => {
      ...
      expect(ValidationUtils.isValidUrl('ftp://example.com', { protocols: ['http', 'https'] })).toBe(false);
    });

    it('should handle query strings', () => {
      expect(ValidationUtils.isValidUrl('https://example.com?query=1', { allowQueryString: true })).toBe(true);
      expect(ValidationUtils.isValidUrl('https://example.com?query=1', { allowQueryString: false })).toBe(false);
    });

    it('should handle fragments', () => {
      expect(ValidationUtils.isValidUrl('https://example.com#section', { allowFragments: true })).toBe(true);
      expect(ValidationUtils.isValidUrl('https://example.com#section', { allowFragments: false })).toBe(false);
    });
  });
  ...
  describe('isValidPhone', () => {
    ...
    it('should handle extensions', () => {
      ...
      expect(ValidationUtils.isValidPhone('5551234567x123', { allowExtensions: false })).toBe(false);
    });
  });
