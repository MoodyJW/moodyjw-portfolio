...
import { emailValidator, passwordStrengthValidator } from '@shared/utilities/validation/validation.utils';
...
export class RegisterComponent {
  ...
  form = this.fb.group({
    ...
    password: ['', [
      Validators.required,
      passwordStrengthValidator({ minLength: 10 }),
    ]],
    confirmPassword: ['', [
      Validators.required,
