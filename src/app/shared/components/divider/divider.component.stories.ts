...
const meta: Meta<DividerComponent> = {
  ...
  argTypes: {
    ...
    label: {
      control: 'text',
      description:
        'Optional label text to display in the center (horizontal only)',
    },
    inset: {
      control: 'boolean',
  ...
  render: (args) => ({
    ...
    template: `
      <div style="padding: 2rem; border: 1px dashed #ccc;">
        ...
        <app-divider [inset]="inset" spacing="sm" />
        <p>Content after</p>
      </div>
    `,
  }),
  ...
  render: () => ({
    template: `
      <div style="padding: 2rem;">
        ...
        <app-divider label="Or" variant="solid" />

        <h4 style="margin-top: 2rem;">Dashed with label</h4>
        <app-divider label="Or" variant="dashed" />

        <h4 style="margin-top: 2rem;">Dotted with label</h4>
        <app-divider label="Or" variant="dotted" />
      </div>
    `,
  }),
};
  ...
  render: () => ({
    template: `
      <div style="display: flex; align-items: center; padding: 1rem; background: #f5f5f5; gap: 1rem;">
        ...
        <app-divider orientation="vertical" spacing="none" style="height: 24px;" />
