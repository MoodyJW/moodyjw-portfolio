...
@Component({
  ...
  template: `
    <!-- Default spinner -->
    <app-loading-spinner ariaLabel="Loading content" />
...
@Component({
  template: `
    ...
    <app-loading-spinner
      size="sm"
      ariaLabel="Small spinner"
    />

    <!-- Medium/Default (32px) -->
    <app-loading-spinner
      size="md"
      ariaLabel="Medium spinner"
    />

    <!-- Large (48px) -->
    <app-loading-spinner
      size="lg"
      ariaLabel="Large spinner"
    />

    <!-- Extra Large (64px) -->
    <app-loading-spinner
      size="xl"
      ariaLabel="Extra large spinner"
    />
  `,
})
...
<app-loading-spinner ariaLabel="Loading user profile" />
...
<!-- Bad: Generic label -->
<app-loading-spinner ariaLabel="Loading" />
```
...
.spinner {
  ...
  &--xl { width: 64px; height: 64px; border-width: 5px; }
