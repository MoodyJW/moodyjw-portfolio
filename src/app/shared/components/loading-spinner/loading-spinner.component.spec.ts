...
describe('LoadingSpinnerComponent', () => {
  ...
  describe('Component Creation', () => {
    ...
    it('should be standalone', () => {
      const metadata = (LoadingSpinnerComponent as unknown as { ɵcmp: { standalone: boolean } }).ɵcmp;
  ...
  describe('Input Handling - AriaLabel', () => {
    ...
    it('should render ariaLabel in template', () => {
      ...
      fixture.detectChanges();
      const spinnerElement = fixture.nativeElement.querySelector('[role="status"]');
  ...
  describe('Input Handling - Message', () => {
    ...
    it('should not render message element when message is undefined', () => {
      fixture.detectChanges();
      const messageElement = fixture.nativeElement.querySelector('.spinner-container__message');
  ...
  describe('Input Handling - Overlay', () => {
    ...
    it('should not render backdrop when overlay is false', () => {
      fixture.componentRef.setInput('overlay', false);
      fixture.detectChanges();
      const backdrop = fixture.nativeElement.querySelector('.spinner-container__backdrop');
  ...
  describe('SVG Rendering', () => {
    it('should render SVG element', () => {
      fixture.detectChanges();
      const svg = fixture.nativeElement.querySelector('.spinner__svg');
      expect(svg).toBeTruthy();
    });

    it('should render circle element within SVG', () => {
      fixture.detectChanges();
      const circle = fixture.nativeElement.querySelector('.spinner__circle');
  ...
  describe('Template Rendering', () => {
    ...
    it('should render content wrapper', () => {
      fixture.detectChanges();
      const content = fixture.nativeElement.querySelector('.spinner-container__content');
