...
export const Default: Story = {
  ...
  render: (args) => ({
    props: args,
    template: `<app-loading-spinner ${argsToTemplate(args)} />`,
  }),
};
    ...
    template: `
      <div style="display: flex; align-items: center; gap: 2rem; flex-wrap: wrap;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner size="sm" ariaLabel="Small spinner" />
          <span style="font-size: 0.875rem; color: var(--color-text);">Small</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner size="md" ariaLabel="Medium spinner" />
          <span style="font-size: 0.875rem; color: var(--color-text);">Medium</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner size="lg" ariaLabel="Large spinner" />
          <span style="font-size: 0.875rem; color: var(--color-text);">Large</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner size="xl" ariaLabel="Extra large spinner" />
...
export const Variants: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <div style="display: flex; align-items: center; gap: 2rem; flex-wrap: wrap;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner variant="primary" ariaLabel="Primary spinner" />
          <span style="font-size: 0.875rem; color: var(--color-text);">Primary</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-loading-spinner variant="secondary" ariaLabel="Secondary spinner" />
        ...
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem; padding: 1rem; background: #333; border-radius: 8px;">
          <app-loading-spinner variant="light" ariaLabel="Light spinner" />
        ...
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem; padding: 1rem; background: #f5f5f5; border-radius: 8px;">
          <app-loading-spinner variant="dark" ariaLabel="Dark spinner" />
  ...
  render: (args) => ({
    ...
    template: `
      <div style="border: 2px dashed var(--color-border); border-radius: 8px; min-height: 200px;">
        <app-loading-spinner ${argsToTemplate(args)} />
      </div>
    `,
  }),
};
