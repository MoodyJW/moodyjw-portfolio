 ...
 *
 * <!-- Multiple text lines -->
 * <app-skeleton variant="text" [count]="3" ariaLabel="Loading content" />
 *
 * <!-- Circular avatar skeleton -->
 * <app-skeleton variant="circular" width="48px" height="48px" ariaLabel="Loading avatar" />
 *
 ...
 * <app-skeleton variant="rectangular" width="100%" height="300px" [spacing]="16" ariaLabel="Loading card" />
 * ```
 */
@Component({
