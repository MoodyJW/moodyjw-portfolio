...
@Component({
  ...
  template: `
    ...
    <app-skeleton ariaLabel="Loading text" />
...
@Component({
  template: `
    ...
    <app-skeleton
      animation="wave"
      ariaLabel="Loading with wave"
    />

    <!-- Pulse animation -->
    <app-skeleton
      animation="pulse"
      ariaLabel="Loading with pulse"
    />
...
<app-skeleton ariaLabel="Loading user profile" />
...
<!-- Bad: Generic label -->
<app-skeleton ariaLabel="Loading" />
```
...
```html
<app-skeleton variant="rectangular" width="100%" height="300px" />
...
```html
<app-skeleton variant="circular" width="60px" height="60px" />
...
@for (row of [1,2,3,4,5]; track row) {
  <app-skeleton variant="rectangular" width="100%" height="40px" />
}
```
