      ...
      <app-card variant="default" padding="md">
        ...
        <div card-footer>
          <div class="card__footer-actions">
            <app-button variant="secondary" ariaLabel="Cancel action">Cancel</app-button>
            <app-button variant="primary" ariaLabel="Confirm action">Confirm</app-button>
          </div>
        </div>
      </app-card>
    `,
    ...
    template: `
      <div style="max-width: 400px;">
        <app-card variant="outlined">
          ...
          <div card-footer>
            <div class="card__footer-actions">
              <app-button variant="primary" ariaLabel="Take action">Action</app-button>
            </div>
          </div>
        </app-card>
      </div>
  ...
  render: (args) => ({
    ...
    template: `
      <app-card ${argsToTemplate(args)}>
        ...
        <div card-footer>
          <div class="card__footer-actions">
            <app-button variant="secondary" ariaLabel="Secondary action">Secondary</app-button>
            <app-button variant="primary" ariaLabel="Primary action">Primary</app-button>
          </div>
        </div>
      </app-card>
    `,
  ...
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 1rem; max-width: 600px;">
        ...
        <app-card variant="outlined" [clickable]="true" ariaLabel="First card">
          <div card-body>
        ...
        <app-card variant="outlined" [clickable]="true" ariaLabel="Second card">
          <div card-body>
        ...
        <app-card variant="outlined" [clickable]="true" ariaLabel="Third card">
          <div card-body>
