...
@Component({
  ...
  template: `
    ...
    <app-card variant="elevated" padding="md">
      ...
      <div card-footer>
        <app-button variant="primary" ariaLabel="Add to cart">
          Add to Cart
        </app-button>
        <app-button variant="secondary" ariaLabel="Learn more">
          Learn More
        </app-button>
      </div>
    </app-card>
...
@Component({
  template: `
    <app-card variant="elevated" padding="none">
      <div card-media>
        <img
          src="product.jpg"
          alt="Product name"
...
<!-- Bad: Missing label -->
<app-card [clickable]="true" (clicked)="viewProject()">
  <!-- content -->
</app-card>
```
