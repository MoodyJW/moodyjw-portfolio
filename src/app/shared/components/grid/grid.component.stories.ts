...
const createGridItem = (index: number, height = '80px') => `
  <div style="
    padding: 1rem;
...
export const ResponsiveGrid: Story = {
  render: () => ({
    template: `
      ...
      <app-grid [cols]="1" [colsMd]="2" [colsLg]="3" [colsXl]="4" gap="lg">
...
export const AutoFitGrid: Story = {
  render: () => ({
    template: `
      ...
      <app-grid cols="auto" [minColWidth]="'250px'" gap="lg">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Auto-fit grid that automatically calculates columns based on available space and minimum width.',
      },
    },
  },
};
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
          ...
          <app-grid [cols]="3" [gapX]="'xl'" [gapY]="'sm'">
            ${Array.from({ length: 6 }, (_, i) => createGridItem(i + 1, '60px')).join('')}
          </app-grid>
        </div>
        ...
        <div>
          ...
          <app-grid [cols]="3" [gapX]="'sm'" [gapY]="'xl'">
            ${Array.from({ length: 6 }, (_, i) => createGridItem(i + 1, '60px')).join('')}
          </app-grid>
        </div>
      </div>
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
          ...
          <app-grid [cols]="3" gap="md" alignItems="start">
        ...
        <div>
          ...
          <app-grid [cols]="3" gap="md" alignItems="end">
            ${createGridItem(1, '60px')}
            ${createGridItem(2, '100px')}
            ${createGridItem(3, '80px')}
          </app-grid>
        ...
        <div>
          ...
          <app-grid [cols]="3" gap="md" alignItems="stretch">
            ${createGridItem(1, '60px')}
            ${createGridItem(2, '100px')}
            ${createGridItem(3, '80px')}
          </app-grid>
...
export const TwelveColumnSystem: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Traditional 12-column grid system with .col-span-* utility classes for precise control.',
      },
    },
  },
};
...
export const DashboardLayoutExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example: Dashboard layout with header, stat cards, main content, and sidebar.',
      },
    },
  },
};
...
export const AccessibilityNotes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Comprehensive accessibility features and best practices for using the grid component.',
      },
    },
  },
};
