...
describe('GridComponent', () => {
  ...
  describe('Accessibility - ARIA Attributes', () => {
    it('should have list role by default', () => {
      ...
      const gridElement = fixture.nativeElement.querySelector('.grid');
  ...
  describe('DOM Structure', () => {
    ...
    it('should apply classes to the div element', () => {
      ...
      const gridElement = fixture.nativeElement.querySelector('div.grid');
      expect(gridElement).toBeTruthy();
    });
    ...
    it('should work with all column variants', () => {
      ...
      variants.forEach((variant) => {
        ...
        if (variant === 'auto') {
          ...
          expect(styles['--grid-cols']).toBe(`repeat(${variant}, 1fr)`);
        }
      });
    });
