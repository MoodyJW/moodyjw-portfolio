...
```html
<app-radio size="sm" label="Small" name="size" value="sm" ariaLabel="Small radio button" />
<app-radio size="md" label="Medium" name="size" value="md" ariaLabel="Medium radio button" />
<app-radio size="lg" label="Large" name="size" value="lg" ariaLabel="Large radio button" />
```
