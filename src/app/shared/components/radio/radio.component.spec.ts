...
describe('RadioComponent', () => {
  ...
  describe('Public Methods', () => {
    ...
    it('should blur the radio element', () => {
      fixture.detectChanges();
      const blurSpy = vi.spyOn(fixture.nativeElement.querySelector('input[type="radio"]'), 'blur');
  ...
  describe('DOM Rendering', () => {
    ...
    it('should render required indicator when required', () => {
      ...
      const requiredIndicator = fixture.nativeElement.querySelector('.input-label__required');
    ...
    it('should render helper text when provided', () => {
      ...
      const helperText = fixture.nativeElement.querySelector(`#${component.helperTextId()}`);
      expect(helperText).toBeTruthy();
      expect(helperText.textContent).toContain('Helper text');
    });

    it('should not render helper text when not provided', () => {
      const helperText = fixture.nativeElement.querySelector('.input-helper-text');
    ...
    it('should render radio indicator dot when checked', () => {
      ...
      const dot = fixture.nativeElement.querySelector('.radio-indicator__dot');
    ...
    it('should apply correct wrapper classes', () => {
      const wrapper = fixture.nativeElement.querySelector('.radio-wrapper');
  ...
  describe('Accessibility', () => {
    ...
    it('should hide radio indicator from screen readers', () => {
      const indicator = fixture.nativeElement.querySelector('.radio-indicator');
