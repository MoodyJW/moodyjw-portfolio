...
@Component({
  ...
  template: `
    ...
    <app-input
      ...
      [(value)]="domain"
      suffix=".com"
      ariaLabel="Enter your domain name"
    />
...
@Component({
  template: `
    ...
    <app-button ariaLabel="Focus input" (clicked)="focusInput()">
      Focus Input
    </app-button>
    <app-button ariaLabel="Select text" (clicked)="selectText()">
      Select Text
    </app-button>
  `,
})
...
<app-input
  label="Email"
  [(value)]="email"
  ariaLabel="Your work email address"
/>
