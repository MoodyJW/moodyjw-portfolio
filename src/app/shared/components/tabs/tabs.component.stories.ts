...
export const Basic: Story = {
  render: () => ({
    props: {},
    template: `
      <app-tabs ariaLabel="Basic tabs example">
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 3rem;">
        <div>
          ...
          <app-tabs variant="default" ariaLabel="Default variant tabs">
            <app-tab tabId="default-1" label="Tab 1"><p>Content for tab 1</p></app-tab>
            <app-tab tabId="default-2" label="Tab 2"><p>Content for tab 2</p></app-tab>
            <app-tab tabId="default-3" label="Tab 3"><p>Content for tab 3</p></app-tab>
          </app-tabs>
        </div>

        <div>
          <h4 style="margin: 0 0 1rem 0;">Pills</h4>
          <app-tabs variant="pills" ariaLabel="Pills variant tabs">
            <app-tab tabId="pills-1" label="Tab 1"><p>Content for tab 1</p></app-tab>
            <app-tab tabId="pills-2" label="Tab 2"><p>Content for tab 2</p></app-tab>
            <app-tab tabId="pills-3" label="Tab 3"><p>Content for tab 3</p></app-tab>
          </app-tabs>
        </div>

        <div>
          <h4 style="margin: 0 0 1rem 0;">Underline</h4>
          <app-tabs variant="underline" ariaLabel="Underline variant tabs">
            <app-tab tabId="underline-1" label="Tab 1"><p>Content for tab 1</p></app-tab>
            <app-tab tabId="underline-2" label="Tab 2"><p>Content for tab 2</p></app-tab>
            <app-tab tabId="underline-3" label="Tab 3"><p>Content for tab 3</p></app-tab>
          </app-tabs>
        </div>

        <div>
          <h4 style="margin: 0 0 1rem 0;">Boxed</h4>
          <app-tabs variant="boxed" ariaLabel="Boxed variant tabs">
            <app-tab tabId="boxed-1" label="Tab 1"><p>Content for tab 1</p></app-tab>
            <app-tab tabId="boxed-2" label="Tab 2"><p>Content for tab 2</p></app-tab>
            <app-tab tabId="boxed-3" label="Tab 3"><p>Content for tab 3</p></app-tab>
          </app-tabs>
        </div>
      </div>
    `,
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 3rem;">
        <div>
          ...
          <app-tabs size="sm" ariaLabel="Small tabs">
            <app-tab tabId="sm-1" label="Tab 1"><p>Small tab content</p></app-tab>
            <app-tab tabId="sm-2" label="Tab 2"><p>Small tab content</p></app-tab>
            <app-tab tabId="sm-3" label="Tab 3"><p>Small tab content</p></app-tab>
          </app-tabs>
        </div>

        <div>
          <h4 style="margin: 0 0 1rem 0;">Medium (Default)</h4>
          <app-tabs size="md" ariaLabel="Medium tabs">
            <app-tab tabId="md-1" label="Tab 1"><p>Medium tab content</p></app-tab>
            <app-tab tabId="md-2" label="Tab 2"><p>Medium tab content</p></app-tab>
            <app-tab tabId="md-3" label="Tab 3"><p>Medium tab content</p></app-tab>
          </app-tabs>
        </div>
        ...
        <div>
          ...
          <app-tabs size="lg" ariaLabel="Large tabs">
            <app-tab tabId="lg-1" label="Tab 1"><p>Large tab content</p></app-tab>
            <app-tab tabId="lg-2" label="Tab 2"><p>Large tab content</p></app-tab>
            <app-tab tabId="lg-3" label="Tab 3"><p>Large tab content</p></app-tab>
          </app-tabs>
        </div>
      </div>
    `,
...
export const WithIcons: Story = {
  render: () => ({
    template: `
      <app-tabs variant="pills" ariaLabel="Tabs with icons">
        <app-tab tabId="home" label="Home" [icon]="'${ICON_NAMES.HOME}'">
          <h3>Home</h3>
          <p>Welcome to the home tab!</p>
        </app-tab>
        <app-tab tabId="profile" label="Profile" [icon]="'${ICON_NAMES.USER}'">
          <h3>Profile</h3>
        ...
        <app-tab tabId="notifications" label="Notifications" [icon]="'${ICON_NAMES.NOTIFICATION}'">
          <h3>Notifications</h3>
  ...
  render: () => ({
    template: `
      <div style="height: 400px;">
        <app-tabs orientation="vertical" ariaLabel="Vertical tabs">
          <app-tab tabId="account" label="Account" [icon]="'${ICON_NAMES.USER}'">
            <h3>Account Settings</h3>
            <p>Manage your account details and preferences.</p>
          </app-tab>
          <app-tab tabId="security" label="Security" [icon]="'${ICON_NAMES.SUCCESS}'">
            <h3>Security</h3>
            <p>Update your password and security settings.</p>
          </app-tab>
          <app-tab tabId="privacy" label="Privacy" [icon]="'${ICON_NAMES.EYE}'">
            <h3>Privacy</h3>
            <p>Control your privacy settings and data sharing.</p>
          </app-tab>
          <app-tab tabId="notifications-v" label="Notifications" [icon]="'${ICON_NAMES.NOTIFICATION}'">
            <h3>Notifications</h3>
...
export const FullWidth: Story = {
  render: () => ({
    template: `
      <app-tabs [fullWidth]="true" variant="pills" ariaLabel="Full width tabs">
        <app-tab tabId="one" label="One">
          <p>First tab with equal width distribution.</p>
        </app-tab>
        <app-tab tabId="two" label="Two">
          <p>Second tab with equal width distribution.</p>
        </app-tab>
        <app-tab tabId="three" label="Three">
...
export const WithDisabledTab: Story = {
  render: () => ({
    template: `
      <app-tabs ariaLabel="Tabs with disabled state">
        <app-tab tabId="available" label="Available">
          <p>This tab is available and can be selected.</p>
        </app-tab>
        <app-tab tabId="disabled" label="Disabled" [disabled]="true">
          <p>This content won't be accessible because the tab is disabled.</p>
        </app-tab>
        <app-tab tabId="also-available" label="Also Available">
...
export const ComplexContent: Story = {
  render: () => ({
    template: `
      <app-tabs variant="underline" size="lg" ariaLabel="Project dashboard tabs">
        <app-tab tabId="dashboard" label="Dashboard" [icon]="'${ICON_NAMES.CHART}'">
        ...
        <app-tab tabId="tasks" label="Tasks" [icon]="'${ICON_NAMES.LIST}'">
          <h3>Task List</h3>
        ...
        <app-tab tabId="team" label="Team" [icon]="'${ICON_NAMES.USER_GROUP}'">
          <h3>Team Members</h3>
  ...
  render: () => ({
    template: `
      <div style="max-width: 600px;">
        ...
        <app-tabs ariaLabel="Keyboard navigation demo">
          <app-tab tabId="first" label="First Tab">
            <p>Try using arrow keys to navigate between tabs!</p>
          </app-tab>
          <app-tab tabId="second" label="Second Tab">
            <p>Press Home to jump to the first tab, or End to jump to the last.</p>
          </app-tab>
          <app-tab tabId="third" label="Third Tab">
  ...
  render: () => ({
    template: `
      <div style="max-width: 600px;">
        ...
        <app-tabs variant="pills" ariaLabel="Accessibility demo tabs">
          <app-tab tabId="a11y-1" label="Overview" [icon]="'${ICON_NAMES.INFO}'">
            <h3>Accessibility Overview</h3>
            <p>This tabs component follows WAI-ARIA authoring practices for tabs.</p>
          </app-tab>
          <app-tab tabId="a11y-2" label="Features" [icon]="'${ICON_NAMES.SUCCESS}'">
            <h3>Accessibility Features</h3>
            <p>Full keyboard navigation, screen reader support, and WCAG AAA compliance.</p>
          </app-tab>
          <app-tab tabId="a11y-3" label="Testing" [icon]="'${ICON_NAMES.BEAKER}'">
            <h3>Testing</h3>
