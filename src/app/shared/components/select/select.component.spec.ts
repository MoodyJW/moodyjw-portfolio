...
describe('SelectComponent', () => {
  ...
  describe('Focus Management', () => {
    ...
    it('should blur button programmatically', () => {
      const button = fixture.debugElement.query(By.css('.select-button'));
      vi.spyOn(button.nativeElement, 'blur');

      component.blur();

      expect(button.nativeElement.blur).toHaveBeenCalled();
    });
  });
  ...
  describe('Label and Helper Text', () => {
    it('should display label when provided', () => {
      ...
      expect(label.nativeElement.textContent).toContain('Select a country');
    });
    ...
    it('should display helper text when provided', () => {
      ...
      const helperText = fixture.debugElement.query(By.css('.select-helper-text'));
      expect(helperText).toBeTruthy();
      expect(helperText.nativeElement.textContent.trim()).toBe('Choose your preferred option');
    });
  ...
  describe('Accessibility', () => {
    it('should have required aria-label', () => {
      const button = fixture.debugElement.query(By.css('.select-button'));
      expect(button.nativeElement.getAttribute('aria-label')).toBe('Test select');
    });
    ...
    it('should set aria-required when required', () => {
      ...
      const button = fixture.debugElement.query(By.css('.select-button'));
      expect(button.nativeElement.getAttribute('aria-required')).toBe('true');
    });
    ...
    it('should set aria-selected on options', () => {
      ...
      expect(options[1].nativeElement.getAttribute('aria-selected')).toBe('false');
    });
