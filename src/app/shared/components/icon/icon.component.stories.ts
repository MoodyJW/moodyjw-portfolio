    ...
    template: `
      <div style="display: flex; gap: 2rem; align-items: center; flex-wrap: wrap;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="xs" ariaLabel="Extra small home icon" color="primary" />
          <span style="font-size: 12px; color: #666;">xs (12px)</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="sm" ariaLabel="Small home icon" color="primary" />
          <span style="font-size: 12px; color: #666;">sm (16px)</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="md" ariaLabel="Medium home icon" color="primary" />
          <span style="font-size: 12px; color: #666;">md (20px)</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="lg" ariaLabel="Large home icon" color="primary" />
          <span style="font-size: 12px; color: #666;">lg (24px)</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="xl" ariaLabel="Extra large home icon" color="primary" />
          <span style="font-size: 12px; color: #666;">xl (32px)</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="2xl" ariaLabel="2x large home icon" color="primary" />
...
export const AllColors: Story = {
  render: () => ({
    template: `
      <div style="display: flex; gap: 2rem; align-items: center; flex-wrap: wrap;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="current" ariaLabel="Current color" />
          <span style="font-size: 12px; color: #666;">current</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="primary" ariaLabel="Primary color" />
          <span style="font-size: 12px; color: #666;">primary</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="secondary" ariaLabel="Secondary color" />
          <span style="font-size: 12px; color: #666;">secondary</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="success" ariaLabel="Success color" />
          <span style="font-size: 12px; color: #666;">success</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="warning" ariaLabel="Warning color" />
          <span style="font-size: 12px; color: #666;">warning</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="error" ariaLabel="Error color" />
          <span style="font-size: 12px; color: #666;">error</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="xl" color="info" ariaLabel="Info color" />
  ...
  render: () => ({
    template: `
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 1.5rem;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HOME}" size="lg" ariaLabel="Home" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Home</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.USER}" size="lg" ariaLabel="User" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">User</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.EMAIL}" size="lg" ariaLabel="Email" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Email</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.SEARCH}" size="lg" ariaLabel="Search" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Search</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.SETTINGS}" size="lg" ariaLabel="Settings" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Settings</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.NOTIFICATION}" size="lg" ariaLabel="Notifications" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Notification</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.HEART}" size="lg" ariaLabel="Heart" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Heart</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.STAR}" size="lg" ariaLabel="Star" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Star</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.CART}" size="lg" ariaLabel="Shopping cart" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Cart</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.MENU}" size="lg" ariaLabel="Menu" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Menu</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.CLOSE}" size="lg" ariaLabel="Close" color="primary" />
          <span style="font-size: 12px; color: #666; text-align: center;">Close</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.CHECK}" size="lg" ariaLabel="Check" color="primary" />
  ...
  render: () => ({
    template: `
      <div style="display: flex; gap: 3rem; align-items: center; flex-wrap: wrap;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.SUCCESS}" size="2xl" color="success" ariaLabel="Success" />
          <span style="font-size: 12px; color: #666;">Success</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.WARNING}" size="2xl" color="warning" ariaLabel="Warning" />
          <span style="font-size: 12px; color: #666;">Warning</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.ERROR}" size="2xl" color="error" ariaLabel="Error" />
          <span style="font-size: 12px; color: #666;">Error</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.INFO}" size="2xl" color="info" ariaLabel="Information" />
          <span style="font-size: 12px; color: #666;">Info</span>
        </div>
      </div>
    `,
  ...
  render: () => ({
    template: `
      <div style="display: flex; gap: 2rem; align-items: center;">
        <app-icon name="${ICON_NAMES.REFRESH}" size="xl" [spin]="true" ariaLabel="Loading" color="primary" />
    ...
    template: `
      <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
        <button style="display: flex; align-items: center; gap: 0.5rem; padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white; cursor: pointer;">
          <app-icon name="${ICON_NAMES.HOME}" size="sm" [decorative]="true" color="primary" />
          Home
        </button>
        <button style="display: flex; align-items: center; gap: 0.5rem; padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white; cursor: pointer;">
          <app-icon name="${ICON_NAMES.SEARCH}" size="sm" [decorative]="true" color="primary" />
          Search
        </button>
        <button style="display: flex; align-items: center; gap: 0.5rem; padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white; cursor: pointer;">
          <app-icon name="${ICON_NAMES.SETTINGS}" size="sm" [decorative]="true" color="primary" />
          Settings
        </button>
        <button style="display: flex; align-items: center; gap: 0.5rem; padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white; cursor: pointer;">
          Download
          <app-icon name="${ICON_NAMES.DOWNLOAD}" size="sm" [decorative]="true" color="primary" />
        </button>
      </div>
    `,
  }),
...
export const ThemeIcons: Story = {
  render: () => ({
    template: `
      <div style="display: flex; gap: 2rem; align-items: center;">
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.SUN}" size="xl" color="warning" ariaLabel="Light mode" />
          <span style="font-size: 12px; color: #666;">Light Mode</span>
        </div>
        <div style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <app-icon name="${ICON_NAMES.MOON}" size="xl" color="primary" ariaLabel="Dark mode" />
...
export const NavigationIcons: Story = {
  render: () => ({
    template: `
      <div style="display: flex; gap: 2rem; align-items: center; flex-wrap: wrap;">
        <app-icon name="${ICON_NAMES.ARROW_LEFT}" size="lg" ariaLabel="Go back" color="primary" />
        <app-icon name="${ICON_NAMES.ARROW_RIGHT}" size="lg" ariaLabel="Go forward" color="primary" />
        <app-icon name="${ICON_NAMES.ARROW_UP}" size="lg" ariaLabel="Go up" color="primary" />
        <app-icon name="${ICON_NAMES.ARROW_DOWN}" size="lg" ariaLabel="Go down" color="primary" />
        <app-icon name="${ICON_NAMES.CHEVRON_LEFT}" size="lg" ariaLabel="Previous" color="primary" />
        <app-icon name="${ICON_NAMES.CHEVRON_RIGHT}" size="lg" ariaLabel="Next" color="primary" />
        <app-icon name="${ICON_NAMES.CHEVRON_UP}" size="lg" ariaLabel="Collapse" color="primary" />
        <app-icon name="${ICON_NAMES.CHEVRON_DOWN}" size="lg" ariaLabel="Expand" color="primary" />
      </div>
    `,
  }),
  parameters: {
      ...
      <div style="max-width: 600px;">
        ...
        <div style="margin-top: 20px; display: flex; gap: 1rem; flex-direction: column;">
          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <app-icon name="${ICON_NAMES.SUCCESS}" color="success" ariaLabel="Task completed successfully" />
            <span>With aria-label (announced by screen readers)</span>
          </div>

          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <app-icon name="${ICON_NAMES.STAR}" [decorative]="true" color="secondary" />
...
export const Interactive: Story = {
  ...
  render: (args) => ({
    props: args,
    template: `<app-icon ${argsToTemplate(args)} />`,
  }),
  parameters: {
    docs: {
      description: {
