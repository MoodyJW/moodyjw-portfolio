...
describe('TabButtonComponent', () => {
  ...
  describe('DOM Rendering', () => {
    ...
    it('should apply tabs__tab class', () => {
      fixture.detectChanges();
      const button = fixture.nativeElement.querySelector('.tabs__tab');
      expect(button).toBeTruthy();
    });
    ...
    it('should apply tabs__tab--active class when active', () => {
      fixture.componentRef.setInput('isActive', true);
      fixture.detectChanges();
      const button = fixture.nativeElement.querySelector('.tabs__tab--active');
      expect(button).toBeTruthy();
    });
    ...
    it('should apply tabs__tab--disabled class when disabled', () => {
      fixture.componentRef.setInput('disabled', true);
      fixture.detectChanges();
      const button = fixture.nativeElement.querySelector('.tabs__tab--disabled');
      expect(button).toBeTruthy();
    });
    ...
    it('should render label text', () => {
      ...
      fixture.detectChanges();
      const label = fixture.nativeElement.querySelector('.tabs__tab-label');
    ...
    it('should apply tabs__tab-icon class to icon', () => {
      fixture.componentRef.setInput('icon', ICON_NAMES.HOME);
      fixture.detectChanges();
      const icon = fixture.nativeElement.querySelector('.tabs__tab-icon');
      expect(icon).toBeTruthy();
    });
  });
  ...
  describe('ARIA Attributes', () => {
    it('should set role="tab" on button', () => {
      fixture.detectChanges();
      const button = fixture.nativeElement.querySelector('[role="tab"]');
      expect(button).toBeTruthy();
    });
    ...
    it('should set aria-label from label', () => {
      fixture.componentRef.setInput('label', 'My Tab');
      fixture.detectChanges();
      const host = fixture.nativeElement.querySelector('[role="tab"]');
      const button =
        host?.querySelector('button') || fixture.nativeElement.querySelector('app-button button');
