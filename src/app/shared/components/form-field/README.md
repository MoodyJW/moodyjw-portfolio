...
@Component({
  template: `
    <app-form-field
      label="Age"
      [control]="ageControl"
      [errorMessages]="ageErrorMessages"
    >
      <input
        type="number"
...
```html
<app-form-field label="Field Label">
...
```html
<app-form-field label="Date" [control]="dateControl">
  <app-date-picker [formControl]="dateControl" />
</app-form-field>
```
...
```html
<app-form-field label="Status" [control]="statusControl">
  <app-select
...
>
  <app-file-upload [formControl]="photoControl" />
</app-form-field>
```
