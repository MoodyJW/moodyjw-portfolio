...
describe('FormFieldComponent', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render without label when not provided', () => {
      ...
      const label = compiled.querySelector('app-input-label');
    ...
    it('should project content into content area', () => {
      const compiled = fixture.nativeElement as HTMLElement;
      const content = compiled.querySelector('.form-field__content');
  ...
  describe('Helper Text', () => {
    ...
    it('should generate unique helper ID when helper text exists', () => {
      ...
      expect(uniqueIdService.generateId).toHaveBeenCalledWith('form-field-helper');
    });
  });
  ...
  describe('Unique IDs', () => {
    it('should generate unique field ID', () => {
      ...
      expect(uniqueIdService.generateId).toHaveBeenCalledWith('form-field');
    });
