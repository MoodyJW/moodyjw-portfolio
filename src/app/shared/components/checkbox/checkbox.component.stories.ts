...
export const Indeterminate: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Indeterminate state is useful for "select all" checkboxes when some but not all items are selected.',
      },
    },
  },
};
...
export const SelectAllPattern: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Common "select all" pattern where the parent checkbox shows indeterminate state when some (but not all) children are selected.',
      },
    },
  },
};
...
export const WithoutLabel: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Checkbox without visible label. ARIA label is required for screen reader accessibility.',
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation support. Try tabbing through the checkboxes and using Space to toggle.',
      },
    },
  },
};
...
export const FormIntegration: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Example of checkboxes integrated into a form with various states and configurations.',
      },
    },
  },
};
