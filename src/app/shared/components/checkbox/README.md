...
```html
<app-checkbox size="sm" label="Small" ariaLabel="Small checkbox" />
<app-checkbox size="md" label="Medium" ariaLabel="Medium checkbox" />
<app-checkbox size="lg" label="Large" ariaLabel="Large checkbox" />
```
