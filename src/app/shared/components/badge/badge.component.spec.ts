...
describe('BadgeComponent', () => {
  ...
  describe('Input Handling - ARIA Attributes', () => {
    ...
    it('should handle custom ariaLive values', () => {
      const ariaLiveValues: Array<'off' | 'polite' | 'assertive'> = [
        'off',
        'polite',
        'assertive',
      ];
  ...
  describe('DOM Rendering', () => {
    ...
    it('should display content text', () => {
      fixture.componentRef.setInput('content', 42);
      fixture.detectChanges();
      const badgeElement = fixture.nativeElement.querySelector('.badge__content');
    ...
    it('should not display content in dot mode', () => {
      fixture.componentRef.setInput('dot', true);
      fixture.detectChanges();
      const contentElement = fixture.nativeElement.querySelector('.badge__content');
