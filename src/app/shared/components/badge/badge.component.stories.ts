  ...
  render: () => ({
    template: `
      <div style="position: relative; display: inline-block; padding: 20px;">
        ...
        <app-badge [content]="5" ariaLabel="5 unread messages" />
      </div>
    `,
  }),
  parameters: {
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center;">
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge [dot]="true" ariaLabel="Has notifications" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Alert</button>
          <app-badge variant="error" [dot]="true" ariaLabel="Has alert" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Success</button>
          <app-badge variant="success" [dot]="true" size="lg" ariaLabel="Success status" />
        </div>
      </div>
    `,
  }),
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center;">
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge [content]="99" [max]="99" ariaLabel="99 messages" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Notifications</button>
          <app-badge [content]="150" [max]="99" ariaLabel="150 notifications" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Items</button>
          <app-badge [content]="1500" [max]="999" ariaLabel="1500 items" />
        </div>
      </div>
    `,
  }),
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center;">
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="success" content="NEW" ariaLabel="New features available" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Beta</button>
          <app-badge variant="warning" content="β" size="lg" ariaLabel="Beta version" />
        </div>
        <div style="position: relative; display: inline-block;">
          <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Status</button>
          <app-badge variant="info" content="!" ariaLabel="Important status update" />
        </div>
      </div>
    `,
  }),
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: flex-start;">
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge [content]="5" ariaLabel="5 items" />
        </div>
        ...
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="error" [content]="3" ariaLabel="3 errors" />
        </div>
        ...
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="success" [content]="12" ariaLabel="12 profile updates" />
        </div>
        ...
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="error" [dot]="true" ariaLabel="Has new notifications" />
        </div>
      </div>
    `,
  }),
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center;">
        <div>
          ...
          <div style="position: relative; display: inline-block;">
            <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Messages</button>
            <app-badge [content]="0" [hideWhenZero]="true" ariaLabel="No messages" />
          </div>
        ...
        <div>
          ...
          <div style="position: relative; display: inline-block;">
            <button style="padding: 8px 16px; border: 1px solid #ccc; border-radius: 4px; background: white;">Messages</button>
            <app-badge [content]="0" [hideWhenZero]="false" ariaLabel="No messages" />
          </div>
...
export const ShoppingCart: Story = {
    ...
    template: `
      <div style="display: flex; gap: 2rem; flex-wrap: wrap; align-items: center;">
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="error" [content]="3" ariaLabel="3 items in cart" />
        </div>
        ...
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="primary" [content]="12" ariaLabel="12 notifications" />
        </div>
        ...
        <div style="position: relative; display: inline-block;">
          ...
          <app-badge variant="success" [content]="99" [max]="99" ariaLabel="99+ messages" />
        </div>
      </div>
    `,
  }),
  parameters: {
    docs: {
      description: {
        story: 'Real-world example showing badges on common UI elements like cart, notifications, and messages.',
      },
    },
  },
};
...
export const AccessibilityDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates accessibility features including ARIA labels, live regions, and keyboard support.',
      },
    },
  },
};
