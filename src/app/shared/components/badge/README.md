  ...
  template: `
    ...
    <div style="position: relative; display: inline-block;">
      ...
      <app-badge
        ...
        ariaLabel="{{ messageCount() }} unread messages"
      />
    </div>
    ...
    <div style="position: relative; display: inline-block;">
      ...
      <app-badge
        content="NEW"
        variant="success"
        ariaLabel="New status available"
      />
    </div>
  `,
})
  ...
  template: `
    ...
    <div class="badge-demo">
      ...
      <app-badge
        [content]="15"
        variant="info"
        ariaLabel="15 information items"
      />
    </div>
  `,
  styles: [`
...
<div style="position: relative; display: inline-block;">
  ...
  <app-badge [content]="5" ariaLabel="5 notifications" />
</div>
```
...
<!-- Bad: Generic label -->
<app-badge [content]="5" ariaLabel="Badge" />
```
...
<app-badge
  [dot]="true"
  ariaLabel="Has new notifications"
/>
```
...
<a href="/cart" style="position: relative;">
  ...
  <app-badge
    [content]="cartCount()"
    ariaLabel="{{ cartCount() }} items in cart"
  />
</a>
```
