  ...
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        <app-toast variant="success" message="Operation completed successfully!" title="Success"></app-toast>
        <app-toast variant="error" message="An error occurred while processing your request." title="Error"></app-toast>
        <app-toast variant="warning" message="This action cannot be undone." title="Warning"></app-toast>
        <app-toast variant="info" message="Here's some helpful information." title="Info"></app-toast>
      </div>
    `,
  }),
  parameters: {
...
export const WithoutTitle: Story = {
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 1rem;">
        <app-toast variant="success" message="Changes saved successfully!"></app-toast>
        <app-toast variant="error" message="Something went wrong."></app-toast>
        <app-toast variant="warning" message="Please review your changes."></app-toast>
        <app-toast variant="info" message="New features available."></app-toast>
      </div>
    `,
  }),
  parameters: {
...
class ToastDemoComponent {
  ...
  showMultiple() {
    ...
    window.setTimeout(() => this.toastService.info('Second notification'), 500);
    window.setTimeout(() => this.toastService.warning('Third notification'), 1000);
  }

  showAtPosition(position: 'bottom-center') {
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 1.5rem; max-width: 600px;">
        ...
        <div>
          ...
          <app-toast variant="error" message="Assertive announcement (interrupts)" title="Error"></app-toast>
        </div>
        ...
        <div>
          ...
          <app-toast variant="info" message="Try pressing Tab to focus the dismiss button" title="Keyboard Test"></app-toast>
        </div>
        ...
        <div>
          ...
          <app-toast variant="success" message="High contrast ensures readability for all users" title="Contrast"></app-toast>
        </div>
