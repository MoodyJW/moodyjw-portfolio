...
export const AllMaxWidthVariants: Story = {
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <app-container maxWidth="sm" padding="md">
        ...
        <app-container maxWidth="md" padding="md">
          <div style="padding: 1.5rem; background: var(--color-surface); border-radius: var(--border-radius); text-align: center;">
        ...
        <app-container maxWidth="full" padding="md">
          <div style="padding: 1.5rem; background: var(--color-surface); border-radius: var(--border-radius); text-align: center;">
  ...
  parameters: {
    docs: {
      description: {
        story: 'All max-width variants: sm (600px), md (900px), lg (1200px), xl (1400px), and full (100%).',
      },
    },
  },
};
...
export const PaddingOptions: Story = {
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <app-container maxWidth="md" padding="none">
        ...
        <app-container maxWidth="md" padding="sm">
          <div style="padding: 1rem; background: var(--color-surface); border: 2px dashed var(--color-border);">
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
          ...
          <app-container maxWidth="md" padding="md" [centerContent]="true">
            <div style="padding: 1.5rem; background: var(--color-surface); border-radius: var(--border-radius); text-align: center;">
        ...
        <div>
          ...
          <app-container maxWidth="md" padding="md" [centerContent]="false">
    ...
    template: `
      <div style="min-height: 100vh; display: flex; flex-direction: column;">
        ...
        <section style="background: linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-hover) 100%); color: white; padding: 4rem 0;">
          <app-container maxWidth="lg" padding="lg">
...
export const NarrowContentExample: Story = {
  render: () => ({
    template: `
      <app-container maxWidth="sm" padding="lg">
        <div style="padding: 2rem; background: var(--color-surface); border-radius: var(--border-radius);">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example: Login form using sm container (600px) for narrow, focused content.',
      },
    },
  },
};
...
export const ArticleContentExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example: Article/blog post content using md container (900px) for optimal reading width.',
      },
    },
  },
};
...
export const DashboardLayoutExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example: Dashboard layout using xl container (1400px) for data-dense interfaces.',
      },
    },
  },
};
...
export const NestedContainers: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstration of nested containers for creating focused content areas within wider layouts.',
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  render: (args) => ({
    props: args,
    template: `
      <app-container ${argsToTemplate(args)}>
        <div style="padding: 2rem; background: var(--color-surface); border-radius: var(--border-radius); text-align: center;">
          ...
          <div style="margin-top: 1.5rem; padding: 1rem; background: var(--color-background); border: 2px dashed var(--color-border); border-radius: var(--border-radius);">
            <p style="margin: 0; font-size: 14px; color: var(--color-text-secondary);">
              Current: <strong>{{ '${args.maxWidth}' }}</strong> max-width,
              <strong>{{ '${args.padding}' }}</strong> padding,
              <strong>{{ '${args.centerContent}' ? 'centered' : 'not centered' }}</strong>
            </p>
          </div>
        </div>
      </app-container>
...
export const AccessibilityNotes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Comprehensive accessibility features and best practices for using the container component.',
      },
    },
  },
};
