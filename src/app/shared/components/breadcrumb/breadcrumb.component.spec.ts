...
describe('BreadcrumbComponent', () => {
  ...
  describe('Input Handling - Items', () => {
    ...
    it('should handle items with fragment', () => {
      const items: BreadcrumbItem[] = [
        { label: 'Docs', route: '/docs', fragment: 'section-1' },
      ];
  ...
  describe('Template Rendering', () => {
    ...
    it('should render ordered list', () => {
      ...
      const ol = fixture.nativeElement.querySelector('ol.breadcrumb__list');
    ...
    it('should render list items for each breadcrumb', () => {
      ...
      const listItems = fixture.nativeElement.querySelectorAll('li.breadcrumb__item');
    ...
    it('should render links for non-current items with routes', () => {
      ...
      const links = fixture.nativeElement.querySelectorAll('a.breadcrumb__link');
    ...
    it('should render ellipsis when items are collapsed', () => {
      ...
      const ellipsis = fixture.nativeElement.querySelector('.breadcrumb__ellipsis');
