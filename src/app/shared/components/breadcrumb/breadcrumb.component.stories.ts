    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
          ...
          <app-breadcrumb [items]="items" variant="default" ariaLabel="Default variant" />
        </div>
        <div>
          <h3 style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 600; color: #4d4d4d;">Slash</h3>
          <app-breadcrumb [items]="items" variant="slash" ariaLabel="Slash variant" />
        </div>
        <div>
          <h3 style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 600; color: #4d4d4d;">Chevron</h3>
          <app-breadcrumb [items]="items" variant="chevron" ariaLabel="Chevron variant" />
        </div>
        <div>
          <h3 style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 600; color: #4d4d4d;">Arrow</h3>
          <app-breadcrumb [items]="items" variant="arrow" ariaLabel="Arrow variant" />
        </div>
      </div>
    `,
  }),
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
          ...
          <app-breadcrumb [items]="items" variant="chevron" size="sm" ariaLabel="Small size" />
        </div>
        <div>
          <h3 style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 600; color: #4d4d4d;">Medium (Default)</h3>
          <app-breadcrumb [items]="items" variant="chevron" size="md" ariaLabel="Medium size" />
        </div>
        <div>
          <h3 style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 600; color: #4d4d4d;">Large</h3>
          <app-breadcrumb [items]="items" variant="chevron" size="lg" ariaLabel="Large size" />
        </div>
      </div>
    `,
  }),
