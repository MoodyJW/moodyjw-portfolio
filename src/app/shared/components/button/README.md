...
@Component({
  ...
  template: `
    <!-- Primary button -->
    <app-button variant="primary" ariaLabel="Submit form">
      Submit
    </app-button>

    <!-- Secondary button with custom size -->
    <app-button variant="secondary" size="lg" ariaLabel="Cancel action">
      Cancel
    </app-button>

    <!-- Danger button for destructive actions -->
    <app-button variant="danger" ariaLabel="Delete item">
      Delete
    </app-button>
...
<app-button iconLeft="heroTrash" [iconOnly]="true" ariaLabel="Delete item" />
...
<app-button variant="primary" ariaLabel="Submit contact form">Submit</app-button>
```
