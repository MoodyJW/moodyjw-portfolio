...
describe('ButtonComponent', () => {
  ...
  describe('Content Projection', () => {
    it('should render projected content', () => {
      ...
      compiled.querySelector('button')!.innerHTML = '<span class="btn__content">Click Me</span>';
      fixture.detectChanges();

      const content = compiled.querySelector('.btn__content');
  ...
  describe('Loading State', () => {
    ...
    it('should render spinner icon element', () => {
      ...
      const spinnerIcon = fixture.nativeElement.querySelector('.btn__spinner-icon');
