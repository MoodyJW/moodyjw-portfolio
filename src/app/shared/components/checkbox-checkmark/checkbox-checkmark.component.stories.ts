  ...
  render: (args) => ({
    ...
    template: `
      <div style="position: relative; width: 20px; height: 20px; background-color: #f0f0f0; border: 2px solid #ccc; border-radius: 4px;">
        <app-checkbox-checkmark [checked]="checked" [indeterminate]="indeterminate" />
      </div>
    `,
  }),
  parameters: {
...
export const Indeterminate: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Indeterminate state - displays a minus icon (heroMinus). Used for "select all" scenarios.',
      },
    },
  },
};
      ...
      <div style="display: flex; gap: 2rem; align-items: center;">
        <div style="text-align: center;">
          <div style="position: relative; width: 20px; height: 20px; background-color: #f0f0f0; border: 2px solid #ccc; border-radius: 4px; margin-bottom: 0.5rem;">
            <app-checkbox-checkmark [checked]="false" [indeterminate]="false" />
          </div>
        ...
        <div style="text-align: center;">
          <div style="position: relative; width: 20px; height: 20px; background-color: #3b82f6; border: 2px solid #3b82f6; border-radius: 4px; margin-bottom: 0.5rem;">
            <app-checkbox-checkmark [checked]="true" [indeterminate]="false" />
          </div>
        ...
        <div style="text-align: center;">
          <div style="position: relative; width: 20px; height: 20px; background-color: #3b82f6; border: 2px solid #3b82f6; border-radius: 4px; margin-bottom: 0.5rem;">
            <app-checkbox-checkmark [checked]="false" [indeterminate]="true" />
          </div>
...
export const IndeterminatePrecedence: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'When both checked and indeterminate are true, indeterminate takes precedence and shows the minus icon.',
      },
    },
  },
};
...
export const DifferentSizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'The checkmark component adapts to different checkbox sizes. The icon size is fixed at "sm" (16px) for optimal visibility.',
      },
    },
  },
};
...
export const WithValidationColors: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'The checkmark component works with different validation state colors from the parent checkbox.',
      },
    },
  },
};
